...
<html>
    ...
    <body>
                ...
                <div v-else class="normal-page">
                    <div class="wrapper">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2">
                                <label></label>
                                <input type="text" v-model="searchMaterial" class="form-control mb-3" @change="loadList()" placeholder="Material">
                            </div>
                            <div class="col-md-2">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <th @click="filterList(3)" style="cursor: pointer;">MATERIAL <i class="bi bi-arrow-down-up"></i></th>
                                <th @click="filterList(4)" style="cursor: pointer;">TIPO <i class="bi bi-arrow-down-up"></i></th>
                                <th @click="filterList(5)" style="cursor: pointer;">USUÁRIO <i class="bi bi-arrow-down-up"></i></th>
                            </tr>
        ...
        <script src="scripts/historyMaterial.js"></script>
