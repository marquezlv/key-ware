                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-2" 
                                ...
                                <div :class="getRoomStatusClass(room)">
                                    <div class="card-body custom-card-body">
                                        ...
                                        <div v-if="getActiveReservationForRoom(room.rowid)">
                                            <p>Reservado por: {{ getActiveReservationForRoom(room.rowid).employee }}</p>
                                            <button class="btn btn-sm btn-success" 
                                                    @click="acceptReservation(getActiveReservationForRoom(room.rowid))">
                                                <i class="bi bi-check-lg"></i> Aceitar
                                            </button>
                                            <button class="btn btn-sm btn-danger" 
                                                    @click="rejectReservation(getActiveReservationForRoom(room.rowid))">
